...
def parse_accounts_from_nav_page(navi_page_soup):
    ...
    for li in div_plist	('li'):
        try:
            ...
            attr_name, account_url = account_href.attrs[0]
...
def parse_single_account(account_ref):
    ...
    weibo_url = find_item_from_spans_by_keyword(content_spans, "weibo.com")
...
def find_div_by_class(div_list, class_id):
    for div in div_list:
        if 'class' in dict(div.attrs) and dict(div.attrs)['class'] == class_id:
            return div
...
filepath = "/Users/xinglin/Weiboyi/coding/azkaban/trunk/AccountCrawler/tool/chuanboyi/data/user_chuanboyi_20140512.txt"
page_count = 58
log("STARTING.............................")
